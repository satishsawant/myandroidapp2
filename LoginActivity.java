...
import realizer.com.mysurvey.registration.RegistrationActivity;
import realizer.com.mysurvey.security.MagicWordAsyncTaskGet;
import realizer.com.mysurvey.security.PaswordtoEmailAsyncTaskPost;
import realizer.com.mysurvey.security.ResetPasswordAsyncTaskPost;
...
public class LoginActivity extends Activity implements OnTaskCompleted
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* int[] androidColors = getResources().getIntArray(R.array.androidcolors);
        ...
        RelativeLayout login= (RelativeLayout) findViewById(R.id.login_relativeLayout);
        login.setBackgroundColor(randomAndroidColor);*/
        ...
        if (res == false) {
            ...
            if(logchk.equals("true") && !uname.equals(userName.getText().toString().trim()))
            {
                ...
                if(Config.isConnectingToInternet(LoginActivity.this)) {
                    loading.setVisibility(View.VISIBLE);
                    LoginAsyncTaskPost obj = new LoginAsyncTaskPost(userName.getText().toString(), password.getText().toString(), deviceID, LoginActivity.this, LoginActivity.this);
                    obj.execute();
                }
                else
                {
    ...
    public void LoginData(String s)
    {
        ...
        try {
            ...
            String userId="",fullname="",initial="",thumbnailurl="",userEmail="",userContact="",userDOB="",userLoginId="";
            String success="";
            ...
            userEmail=rootObj.getString("Email");
            userContact=rootObj.getString("ContactNo");
            userDOB=rootObj.getString("Dob");
            userLoginId=rootObj.getString("LoginUserId");
            ...
            if (success.equals("true")) {
                ...
                edit.putString("userContact",userContact);
                edit.putString("userDOB",userDOB);
                edit.putString("userInitial",initial);
                edit.putString("userLoginId",userLoginId);
                edit.putString("userThumbnailURL",thumbnailurl);
            ...
            {
                Config.alertDialog(LoginActivity.this,"Error","Invalid Username/Password");
            }
