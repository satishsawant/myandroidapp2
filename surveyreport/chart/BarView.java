package realizer.com.mysurvey.surveyreport.chart;
...
import realizer.com.mysurvey.utils.Singleton;

/**
 * Created by Win on 24/12/2016.
 */
public class BarView extends View {
    ...
    private final int BACKGROUND_COLOR = Color.parseColor("#e0f2f1");
    private final int FOREGROUND_COLOR = Color.parseColor("#00bfa5");
    ...
    public BarView(Context context, AttributeSet attrs){
        ...
        rect = new Rect();
        topMargin = Singleton.dip2px(context, 5);
        int textSize = Singleton.sp2px(context, 15);
        barWidth = Singleton.dip2px(context,22);
        MINI_BAR_WIDTH = Singleton.dip2px(context,22);
        BAR_SIDE_MARGIN  = Singleton.dip2px(context,22);
        TEXT_TOP_MARGIN = Singleton.dip2px(context, 5);
        textPaint = new Paint();
